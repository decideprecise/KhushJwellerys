<?php
/**
 * Rara eCommerce Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Rara_eCommerce_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Rara_eCommerce_Slider_Control extends WP_Customize_Control {

		public $type = 'rara-ecommerce-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'rara-ecommerce-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'rara-ecommerce-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
