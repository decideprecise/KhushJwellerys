<?php
/**
 * Rara eCommerce Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Rara_eCommerce_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Rara_eCommerce_Repeater_Setting extends WP_Customize_Setting {
